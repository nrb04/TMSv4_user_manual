...
\begin{figure}[ht]
  \centering
  \colorbox{gray!20}{\includegraphics[width=.97\textwidth]{img/common/commonarea/results/CompareTheDay.png}}  % Replace with the path to your image file
